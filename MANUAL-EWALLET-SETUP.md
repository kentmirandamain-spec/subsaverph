...
When a buyer submits a GCash/Maya reference (or auto e-wallet pays), you get an **email** to your owner inbox (`ownerInbox` in Admin, or `ORDER_NOTIFY_EMAIL` / `SUPPORT_INBOX` on Render). SMS is not used.
